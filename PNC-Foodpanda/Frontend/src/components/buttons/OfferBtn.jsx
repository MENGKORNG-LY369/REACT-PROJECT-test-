...
function OfferBtn() {
  return (
    <button className='px-5 py-[8px] hover:transition-all text-sm flex gap-2 outline outline-[1px] outline-pink-600 rounded-[5px] text-pink-600 transition-all hover:bg-pink-100'>
